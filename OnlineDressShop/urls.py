...
urlpatterns = [
    ...
    path('pay/<am>/<oid>',views.pay),
    path('online/<am>/<ooid>',views.online),
    ...
    path('viewdressusersearch',views.viewdressusersearch),
    path('bankacc',views.bankacc),
    path('bankaccpost',views.bankaccpost),
    path('delba/<id>',views.delba),
]
